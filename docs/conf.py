...
project = "Ona Data API"
copyright = "2024, Ona Systems, Inc."
...
latex_documents = [
    ("index", "OnaAPI.tex", "Ona API Documentation", "Ona", "manual"),
]
...
man_pages = [("index", "onaapi", "Ona API Documentation", ["Ona"], 1)]
