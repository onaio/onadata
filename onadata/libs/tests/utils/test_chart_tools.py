...
def find_field_by_xpath(xform, field_xpath):
    return [
        e
        for e in xform.survey_elements
        if get_abbreviated_xpath(e.get_xpath()) == field_xpath
    ][0]
...
class TestChartTools(TestBase):
    ...
    def test_build_chart_data_for_field_on_submitted_by_group_by(self):
        ...
        self.assertEqual(
            data["data"],
            [{"_submitted_by": "bob", "items": [{"count": 2, "pizza_fan": ["No"]}]}],
        )
    ...
    def test_build_chart_data_for_numeric_field_group_by_category_field(self):
        ...
        data = build_chart_data_for_field(self.xform, field, group_by=group_by_field)
        ...
        self.assertEqual(
            data["data"],
            [{"count": 2, "sum": 150000.0, "pizza_type": [], "mean": 75000.0}],
        )
    ...
    def test_build_chart_data_for_category_field_group_by_category_field(self):
        ...
        self.assertEqual(data["data_type"], "categorized")
        self.assertEqual(
            sorted(data["data"], key=lambda k: k["gender"]),
            [
                {"gender": ["Female"], "items": [{"count": 1, "pizza_fan": ["No"]}]},
                {"gender": ["Male"], "items": [{"count": 1, "pizza_fan": ["No"]}]},
            ],
        )
    ...
    def test_build_chart_category_field_group_by_category_field_in_group(self):
        ...
        self.assertEqual(
            ...
            [
                {
                    "gender": ["Female"],
                    "items": [{"a_group/grouped": ["Yes"], "count": 1}],
                },
                {
                    "gender": ["Male"],
                    "items": [{"a_group/grouped": ["Yes"], "count": 1}],
    ...
    def test_build_chart_data_cannot_group_by_field(self):
        ...
        with self.assertRaises(ParseError) as e:
            build_chart_data_for_field(self.xform, field, group_by=group_by_field)
    ...
    def test_build_chart_data_for_field_with_language(self):
        ...
        data = build_chart_data_for_field(
            self.xform, field, language_index=language_index
        )
    ...
    def test_get_choice_label_with_single_select(self):
        choices = [
            {"control": {}, "name": "Western Rural", "label": "Western Rural"},
            {"control": {}, "name": "Western Urban", "label": "Western Urban"},
        ]
    ...
    def test_get_choice_label_for_multi_select(self):
        ...
        choices = [
            {"control": {}, "name": "1", "label": pam},
            {"control": {}, "name": "2", "label": croix_rouge},
            {"control": {}, "name": "3", "label": "OXFAM"},
            {"control": {}, "name": "4", "label": "Administration Locale"},
        ]
        string = "1 2"
    ...
    def test_get_choice_label_for_multi_select_with_spaces(self):
        ...
        choices = [
            {"control": {}, "name": pam, "label": pam},
            {"control": {}, "name": croix_rouge, "label": croix_rouge},
            {"control": {}, "name": both, "label": both},
            {
                "control": {},
    ...
    def test_get_choice_label_when_label_not_in_choice_list(self):
        choices = [
            {"control": {}, "name": "Western Rural", "label": "Western Rural"},
            {"control": {}, "name": "Urban", "label": "Urban"},
            {"control": {}, "name": "Western Urban", "label": "Western Urban"},
        ]
        string = "Banadir"
    ...
    def test_select_one_choices(self):
        ...
        expected_data = {
            ...
            "field_xpath": "name_I",
            "data": [{"count": 1, "name_I": ["Aynalem Tenaw"]}],
            "grouped_by": None,
    ...
    def test_select_one_choices_group_by(self):
        ...
        expected_data = {
            ...
            "grouped_by": "name_I",
            "field_label": "Total expenditure per capita",
            "field_name": "toexppc",
        }
    ...
    def test_build_chart_data_for_group_by_submitted_by(self):
        ...
        self.assertEqual(data["field_type"], "select one")
        self.assertEqual(data["data_type"], "categorized")
        self.assertEqual(data["grouped_by"], "_submitted_by")
        self.assertEqual(
            data["data"],
            [
                {"_submitted_by": "bob", "count": 1, "gender": ["Female"]},
                {"_submitted_by": "bob", "count": 1, "gender": ["Male"]},
            ],
        )
    ...
    def test_build_chart_data_for_non_numeric_field_group_by_two_fields(self):
        ...
        self.assertEqual(
            data["data"],
            [
                {"date": "2014-01-09", "pizza_fan": "no", "count": 1, "name": ["Efgh"]},
                {"date": "2014-01-10", "pizza_fan": "no", "count": 1, "name": ["Ghi"]},
            ],
        )
        ...
        input_data = [
            {
                "count": 1,
                "a_var": "female",
                "a_super_group_name/extra_long_variable_name_to_see_if_postgresq": "melon",
            }
        ]
        expected_data = [
            {
                "items": [
                    {
                        "count": 1,
                        "a_super_group_name/extra_long_variable_name_to_see_if_postgresq": "melon",  # noqa
                    }
                ],
                "a_var": "female",
            }
