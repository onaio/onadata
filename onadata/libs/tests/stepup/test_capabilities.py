...
class TestAccountCapabilities(TestCase):
    # ENABLE_TWO_FACTOR pinned rather than inherited: the capability answers
    # False wherever the deployment leaves two-factor off, which is the
    # shipped default -- this case is about who manages it, not whether the
    # environment turned it on.
