...
from onadata.libs.utils.common_tags import (
    ...
    GROUP_DELIMITER_SLASH_TAG, GROUP_DELIMITER_DOT_TAG,
...
class ExportBuilder(object):
    ...
    GROUP_DELIMITER_SLASH = GROUP_DELIMITER_SLASH_TAG
    GROUP_DELIMITER_DOT = GROUP_DELIMITER_DOT_TAG
    GROUP_DELIMITER_UNDER_SCORE = GROUP_DELIMITER_UNDER_SCORE_TAG
    GROUP_DELIMITER = GROUP_DELIMITER_SLASH
    GROUP_DELIMITERS = [GROUP_DELIMITER_SLASH, GROUP_DELIMITER_DOT,
                        GROUP_DELIMITER_UNDER_SCORE]
