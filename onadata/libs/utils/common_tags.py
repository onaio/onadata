...
UUID = "_uuid"  # pylint: disable=invalid-name
PICTURE = "picture"
GPS = "location/gps"
...
DECRYPTION_FAILURE_NOT_ALL_MEDIA_RECEIVED = "NOT_ALL_MEDIA_RECEIVED"
DECRYPTION_FAILURE_MESSAGES = {
    ...
    DECRYPTION_FAILURE_NOT_ALL_MEDIA_RECEIVED: _(
        "Not all media files have been received."
    ),
}
...
INSTANCE_EDIT_CONFLICT_REJECT = "reject"
INSTANCE_EDIT_CONFLICT_LAST_WINS = "last_write_wins"
