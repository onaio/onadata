...
def get_users_org_permissions_cache(users, organization):
    """
    Efficiently fetch organization permissions for multiple users at once to avoid N+1 queries.
    ...
    from onadata.apps.api.models.organization_profile import (
        OrgProfileGroupObjectPermission,
        OrgProfileUserObjectPermission,
    )
