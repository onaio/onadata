...
public class ReusableFunctions {
    ...
    public static Map<String, String> addFileInHeader(String filename, String fileKey, String fileType) {
    ...
    public static <K, V> Map<K, V> headers(String headerAuthorization, String apiToken, Object... keyValues) {
    ...
    public static void setDigestAuth (String username, String password)
    {
        contentType("application/json");
        general.EnvGlobals.requestSpecification = REQUEST.given();
        general.EnvGlobals.requestSpecification = REQUEST.given().auth().digest(username, password);
    }
}
