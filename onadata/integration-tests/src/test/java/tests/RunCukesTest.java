...
@CucumberOptions(features = { "src/test/resources/feature" },
       ...
       tags={"@Projects,@Forms,@Data,@Charts,@Widgets,@FormList,@MergedDatasets,@FilteredDatasets,@Media,@Reviews,@Notes,@Metadata," +
               "@SubmissionStats,@RestServices,@Organizations,@Messaging,@Profiles,@Teams,@Users"})
