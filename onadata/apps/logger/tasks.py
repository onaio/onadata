...
@app.task(retry_backoff=3, autoretry_for=(DatabaseError, ConnectionError))
def register_instance_export_columns_async(instance_pk: int) -> None:
    """Register Instance export columns asynchronously
    ...
    try:
        ...
        register_instance_export_columns(instance)


@app.task(retry_backoff=3, autoretry_for=(DatabaseError, ConnectionError))
def register_xform_export_columns_async(xform_id: int) -> None:
    ...
    try:
        ...
        register_xform_export_columns(xform)
