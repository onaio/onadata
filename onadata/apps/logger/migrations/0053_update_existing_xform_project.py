...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        db.execute('with project_xforms as (select project_id, xform_id from logger_projectxform) update logger_xform set project_id = px.project_id from project_xforms px where px.xform_id = logger_xform.id;')
