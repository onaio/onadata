...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Instance.submitted_by'
        db.add_column(u'logger_instance', 'submitted_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='submitted_instances', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Instance.submitted_by'
        db.delete_column(u'logger_instance', 'submitted_by_id')
    ...
    models = {
        ...
        'logger.instance': {
            ...
            'submitted_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'submitted_instances'", 'null': 'True', 'to': u"orm['auth.User']"}),
