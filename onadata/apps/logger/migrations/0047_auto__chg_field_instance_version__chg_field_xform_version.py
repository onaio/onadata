...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Instance.version'
        db.alter_column(u'logger_instance', 'version', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'XForm.version'
        db.alter_column(u'logger_xform', 'version', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Instance.version'
        db.alter_column(u'logger_instance', 'version', self.gf('django.db.models.fields.CharField')(max_length=14, null=True))

        # Changing field 'XForm.version'
        db.alter_column(u'logger_xform', 'version', self.gf('django.db.models.fields.CharField')(max_length=14, null=True))
