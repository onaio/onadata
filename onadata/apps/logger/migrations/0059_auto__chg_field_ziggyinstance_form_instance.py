...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ZiggyInstance.form_instance'
        # db.alter_column(u'logger_ziggyinstance', 'form_instance', self.gf('jsonfield.fields.JSONField')())
        sql = u'ALTER TABLE logger_ziggyinstance ALTER form_instance TYPE json USING form_instance::json'
        db.execute(sql)

    def backwards(self, orm):

        # Changing field 'ZiggyInstance.form_instance'
        # db.alter_column(u'logger_ziggyinstance', 'form_instance', self.gf('django.db.models.fields.TextField')())
        sql = u'ALTER TABLE logger_ziggyinstance ALTER form_instance TYPE text USING form_instance::text'
        db.execute(sql)
    ...
    models = {
        ...
        'logger.ziggyinstance': {
            ...
            'date_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'entity_id': ('django.db.models.fields.CharField', [], {'max_length': '249'}),
            'form_instance': ('jsonfield.fields.JSONField', [], {}),
