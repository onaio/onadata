...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Widget'
        db.create_table(u'logger_widget', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('object_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('widget_type', self.gf('django.db.models.fields.CharField')(default='charts', max_length=25)),
            ...
            ('group_by', self.gf('django.db.models.fields.CharField')(default=None, max_length=50, null=True)),
            ('title', self.gf('django.db.models.fields.CharField')(default=None, max_length=50, null=True)),
        ...
        db.send_create_signal('logger', ['Widget'])


    def backwards(self, orm):
        # Deleting model 'Widget'
        db.delete_table(u'logger_widget')
    ...
    models = {
        ...
        'logger.widget': {
            ...
            'group_by': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '50', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '32', 'db_index': 'True'}),
            'object_id': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'title': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '50', 'null': 'True'}),
            'view_type': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'widget_type': ('django.db.models.fields.CharField', [], {'default': "'charts'", 'max_length': '25'})
        },
        'logger.xform': {
