...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ZiggyInstance.xform'
        db.add_column(u'odk_logger_ziggyinstance', 'xform',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='ziggy_submissions', null=True, to=orm['odk_logger.XForm']),
                      keep_default=False)
