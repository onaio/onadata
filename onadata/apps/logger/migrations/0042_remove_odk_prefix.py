...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table('odk_logger_attachment', 'logger_attachment')
        db.rename_table('odk_logger_instance', 'logger_instance')
        db.rename_table('odk_logger_instancehistory', 'logger_instancehistory')
        db.rename_table('odk_logger_note', 'logger_note')
    ...
    def backwards(self, orm):
        ...
        db.rename_table('logger_instance', 'odk_logger_instance')
        db.rename_table('logger_instancehistory', 'odk_logger_instancehistory')
        db.rename_table('logger_note', 'odk_logger_note')
        db.rename_table('logger_surveytype', 'odk_logger_surveytype')
        db.rename_table('logger_xform', 'odk_logger_xform')
        db.rename_table('logger_ziggyinstance', 'odk_logger_ziggyinstance')
