...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'logger_xform', 'title', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'XForm.title'
        db.alter_column(u'logger_xform', 'title', self.gf('django.db.models.fields.CharField')(max_length=64))
