...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Note'
        db.create_table(u'odk_logger_note', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('note', self.gf('django.db.models.fields.TextField')()),
            ('instance', self.gf('django.db.models.fields.related.ForeignKey')(related_name='notes', to=orm['odk_logger.Instance'])),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('date_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('odk_logger', ['Note'])


    def backwards(self, orm):
        # Deleting model 'Note'
        db.delete_table(u'odk_logger_note')
