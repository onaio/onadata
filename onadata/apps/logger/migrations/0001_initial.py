    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('extension', models.CharField(default='non', max_length=10, db_index=True)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('date_modified', models.DateTimeField(auto_now=True)),
                ('created_by', models.ForeignKey(related_name='project_owner', to=settings.AUTH_USER_MODEL)),
                ('organization', models.ForeignKey(related_name='project_org', to=settings.AUTH_USER_MODEL)),
                ('tags', taggit.managers.TaggableManager(to='taggit.Tag', through='taggit.TaggedItem', help_text='A comma-separated list of tags.', verbose_name='Tags')),
                ('user_stars', models.ManyToManyField(related_name='project_stars', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'permissions': (('view_project', 'Can view project'), ('add_project_xform', 'Can add xform to project'), ('report_project_xform', 'Can make submissions to the project'), ('transfer_project', 'Can transfer project to different owner'), ('can_export_project_data', 'Can export data in project')),
            },
            bases=(models.Model,),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('widget_type', models.CharField(default=b'charts', max_length=25, choices=[(b'charts', b'Charts')])),
                ('view_type', models.CharField(max_length=50)),
                ('column', models.CharField(max_length=50)),
                ('group_by', models.CharField(default=None, max_length=50, null=True, blank=True)),
                ...
                ('key', models.CharField(unique=True, max_length=32, db_index=True)),
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('date_modified', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'permissions': (('view_xform', 'Can view associated data'), ('report_xform', 'Can make submissions to the form'), ('move_xform', 'Can move form between projects'), ('transfer_xform', 'Can transfer form ownership.'), ('can_export_xform_data', 'Can export form data')),
            },
            bases=(models.Model,),
        ),
        migrations.AlterUniqueTogether(
            name='xform',
            unique_together=set([('user', 'id_string', 'project'), ('user', 'sms_id_string', 'project')]),
        ),
        migrations.AlterUniqueTogether(
            name='project',
