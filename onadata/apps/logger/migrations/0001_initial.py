    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("query", models.JSONField(default={}, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "project",
                    models.ForeignKey(to="logger.Project", on_delete=models.CASCADE),
                ),
                (
                    "tags",
                    taggit.managers.TaggableManager(
        ...
        migrations.AlterUniqueTogether(
            name="xform",
            unique_together=set(
                [("user", "id_string", "project"), ("user", "sms_id_string", "project")]
            ),
        ),
        migrations.AlterUniqueTogether(
            name="project",
        ...
        migrations.AddField(
            model_name="dataview",
            name="project",
            field=models.ForeignKey(to="logger.Project", on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name="dataview",
