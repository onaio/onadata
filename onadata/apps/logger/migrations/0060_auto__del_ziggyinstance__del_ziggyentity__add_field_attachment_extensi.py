...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'logger_ziggyinstance')

        # Deleting model 'ZiggyEntity'
        db.delete_table(u'logger_ziggyentity')

    def backwards(self, orm):
        # Adding model 'ZiggyInstance'
        db.create_table(u'logger_ziggyinstance', (
            ...
            ('form_version', self.gf('django.db.models.fields.CharField')(default=u'1.0', max_length=10)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('server_version', self.gf('django.db.models.fields.BigIntegerField')()),
            ('xform', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ziggy_submissions', null=True, to=orm['logger.XForm'])),
            ('date_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('date_deleted', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True)),
            ('instance_id', self.gf('django.db.models.fields.CharField')(max_length=249, unique=True)),
            ('form_instance', self.gf('jsonfield.fields.JSONField')()),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('client_version', self.gf('django.db.models.fields.BigIntegerField')(default=None, null=True)),
        ))
        db.send_create_signal('logger', ['ZiggyInstance'])

        # Adding model 'ZiggyEntity'
        db.create_table(u'logger_ziggyentity', (
            ('entity_id', self.gf('django.db.models.fields.CharField')(max_length=249)),
            ('date_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('date_deleted', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ...
        db.send_create_signal('logger', ['ZiggyEntity'])

        # Deleting field 'Attachment.extension'
        db.delete_column(u'logger_attachment', 'extension')


        # Changing field 'Attachment.media_file'
        db.alter_column(u'logger_attachment', 'media_file', self.gf('django.db.models.fields.files.FileField')(max_length=100))
