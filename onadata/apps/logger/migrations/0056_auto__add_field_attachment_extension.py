...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Attachment.extension'
        db.add_column(u'logger_attachment', 'extension',
                      self.gf('django.db.models.fields.CharField')(default=u'non', max_length=10, db_index=True),
                      keep_default=False)
