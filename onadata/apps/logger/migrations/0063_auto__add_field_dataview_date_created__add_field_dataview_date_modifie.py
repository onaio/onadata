...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DataView.date_created'
        db.add_column(u'logger_dataview', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2015, 5, 26, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'DataView.date_modified'
        db.add_column(u'logger_dataview', 'date_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2015, 5, 26, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DataView.date_created'
        db.delete_column(u'logger_dataview', 'date_created')

        # Deleting field 'DataView.date_modified'
        db.delete_column(u'logger_dataview', 'date_modified')
