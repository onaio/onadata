...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Instance.version'
        db.add_column(u'logger_instance', 'version',
                      self.gf('django.db.models.fields.CharField')(max_length=14, null=True),
                      keep_default=False)

        # Adding field 'XForm.version'
        db.add_column(u'logger_xform', 'version',
                      self.gf('django.db.models.fields.CharField')(max_length=14, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Instance.version'
        db.delete_column(u'logger_instance', 'version')

        # Deleting field 'XForm.version'
        db.delete_column(u'logger_xform', 'version')
    ...
    models = {
        ...
        'logger.instance': {
            ...
            'version': ('django.db.models.fields.CharField', [], {'max_length': '14', 'null': 'True'}),
