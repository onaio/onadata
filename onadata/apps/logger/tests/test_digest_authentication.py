...
class TestDigestAuthentication(TestBase):
    ...
    def test_authenticated_submissions(self):
        ...
        self._make_submission(xml_submission_file_path, add_uuid=True, auth=auth)
    ...
    def test_fail_authenticated_submissions_to_wrong_account(self):
        ...
        self._make_submission(
            xml_submission_file_path, add_uuid=True, auth=DigestAuth("alice", "alice")
        )
    ...
    @override_settings(DIGEST_ACCOUNT_BACKEND=ODK_TOKEN_STORAGE)
    ...
    @override_settings(ODK_KEY_LIFETIME=1, DIGEST_ACCOUNT_BACKEND=ODK_TOKEN_STORAGE)
