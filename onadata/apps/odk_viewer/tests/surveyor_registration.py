...
from onadata.apps.odk_logger.factory import XFormManagerFactory
...
class TestSurveyorRegistration(TestCase):
    ...
    def test_registration_creates_surveyor(self):
        xform_factory.create_registration_instance({
            u'start': datetime.now(), u'name': u'Steak Sauce',
            u'device_id': u'12345'})
    ...
    def test_multiple_registrations_on_the_same_phone(self):
        ...
        xform_factory.create_registration_instance({
            u'start': ordered_times[0], u'name': u'Betty Bimbob',
            u'sex': u'female', u'birth_date': u'1970-07-07',
            u'device_id': u'12345'})

        xform_factory.create_registration_instance({
            u'start': ordered_times[1], u'name': u'Alex Adams',
            u'birth_date': u'1986-08-15', u'device_id': u'12345'})
    ...
    def test_multiple_submissions_out_of_order(self):
        ...
        xform_factory.create_registration_instance({
            u'form_id': self.xf.id_string, u'start': ordered_times[0],
            u'name': u'Betty Bimbob', u'sex': u'female',
            u'birth_date': u'1970-07-07', u'device_id': u'12345'})

        xform_factory.create_registration_instance({
            u'form_id': self.xf.id_string, u'start': ordered_times[2],
