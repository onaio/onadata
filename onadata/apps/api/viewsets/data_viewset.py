...
class DataViewSet(
    ...
    # pylint: disable=too-many-locals,too-many-branches,too-many-arguments,too-many-positional-arguments,line-too-long
    ...
    def list(self, request, *args, **kwargs):
        ...
        decryption_status = request.query_params.get("decryption_status")
        ...
        if is_public_request:
            ...
            if decryption_status is not None:
