...
class StepUpViewSet(StepUpCallbackMixin, ViewSet):
    """Completes a federated step-up and hands the grant back to the SPA."""
    ...
    def start(self, request):
        ...
        The SPA asks before acting rather than waiting for a 401, because it
        must open the popup inside the click handler -- a popup opened later,
        from an async response, is what browsers block.
        """
