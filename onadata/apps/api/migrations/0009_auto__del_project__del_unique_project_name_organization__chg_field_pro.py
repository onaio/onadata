...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'api_projectxform', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['logger.Project']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ProjectXForm.project'
        db.alter_column(u'api_projectxform', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.Project']))
