# Generated by Django 5.2.15 on 2026-08-31 06:51
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('api', '0009_hashedrecoverydevice_hashedrecoverycode'),
        migrations.swappable_dependency(settings.AUTH_USER_MODEL),
    ]

    operations = [
        migrations.RemoveField(
            model_name='hashedrecoverydevice',
            name='user',
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('device', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='codes', to='api.encryptedrecoverydevice')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.DeleteModel(
            name='HashedRecoveryCode',
        ),
        migrations.DeleteModel(
            name='HashedRecoveryDevice',
        ),
    ]
