...
from onadata.apps.odk_logger.views import view_submission_list
from onadata.apps.odk_logger.views import view_download_submission
from onadata.apps.odk_logger.views import form_upload
