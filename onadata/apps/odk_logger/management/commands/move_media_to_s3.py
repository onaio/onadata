...
from onadata.apps.odk_logger.models.attachment import upload_to as attachment_upload_to
from onadata.apps.odk_logger.models.xform import XForm, upload_to as xform_upload_to
