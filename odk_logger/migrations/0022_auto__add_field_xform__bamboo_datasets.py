...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'XForm._bamboo_datasets'
        db.add_column('odk_logger_xform', '_bamboo_datasets', self.gf('django.db.models.fields.TextField')(default=u''), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'XForm._bamboo_datasets'
        db.delete_column('odk_logger_xform', '_bamboo_datasets')
    ...
    models = {
        ...
        'odk_logger.xform': {
            ...
            '_bamboo_datasets': ('django.db.models.fields.TextField', [], {'default': 'u\'\''}),
